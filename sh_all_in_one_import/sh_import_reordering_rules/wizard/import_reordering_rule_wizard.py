...
class ImportReorderingRulesWizard(models.TransientModel):
    ...
    method = fields.Selection([('create', 'Create New Reordering Rules'),
                                ...
                                if search_product and search_product.type == 'product':
                                    ...
                                    if self.method == 'create':
                                        ...
                                        if search_reordering_rule:
                                            ...
                                            skipped_line_no[str(
                                                counter
                                            )] = " - No Reordering Rule is found for this product "
                                    counter = counter + 1
                                else:
                                    skipped_line_no[str(
                                        counter
                                    )] = " - Product not found or it's not a Stockable Product. "
                                    counter = counter + 1
                                    continue
                            else:
                                skipped_line_no[str(
