        ...
        if self and self.file:
            ...
            if self.import_type == 'csv':
                    ...
                    for row in myreader:
                        try:
                            ...
                            if self.attendance_by == 'badge':
                                badge = False
                                if row[0] != '':
                                    badge = self.env['hr.employee'].sudo(
                                    ).search([('barcode', '=', row[0])],
                                             limit=1)
                                    if badge:
                                        badge = badge.id
                                    else:
                                ...
                                if row[1] != '':
                                    if row[1]:
                                        ...
                                        skipped_line_no[str(
                                            counter
                                        )] = " - Check in Date and Time not found. "
                                        counter = counter + 1
                                        continue
                                check_out_time = None
                                if row[2] != '':
                                    if row[2]:
                                        ...
                                        skipped_line_no[str(
                                            counter
                                        )] = " - Check out Date and Time not found. "
                                        counter = counter + 1
                                        continue
                                vals.update({
                                    'employee_id': badge,
                ...
                if counter > 1:
                    ...
                    res = self.show_success_msg(completed_attendance,
                                                skipped_line_no)
                    return res
