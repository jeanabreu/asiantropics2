                                        ...
                                        if self.payment_option == 'partial':
                                            ...
                                            if created_inv and len(journals) > 0 and len(payment_amount) > 0 and len(journals) == len(payment_amount):
                                                ...
                                                for i in range(0,len(journals)):
                                                    ...
                                                    journal_id = self.env['account.journal'].sudo().search([('name','=',journals[i])],limit=1)
                                                    if journal_id:
                                                        payment_dic.update({
                                ...
                                if self.payment_option == 'partial':
                                    if row[10] not in (None,""):
                                        ...
                                        for journal in journals_split:
                                            account_journal_id = self.env['account.journal'].sudo().search([('name','=',journal)],limit=1)
                                    ...
                                    if row[10] not in (None,""):
                                        ...
                                        if ',' in row_10:
                                            ...
                                            account_journal_id = self.env['account.journal'].sudo().search([('name','=',row_10)],limit=1)
                                            if account_journal_id:
                                ...
                                if created_inv:
                                    ...
                                    if search_product:
                                        ...
                                        if self.account_option == 'default':
                                            ...
                                            account_id = self.env['account.account'].sudo().search([('code','=',row[3])],limit=1)
                                            if account_id:
                                                account = account_id
                                ...
                                if self.payment_option == 'partial':
                                    ...
                                    if sheet.cell(row, 10).value not in (None,""):
                                        ...
                                        if ',' in row_10:
                                            ...
                                            journal = self.env['account.journal'].sudo().search([('name','=',row_10)],limit=1)
                                            if journal:
                                                journal_id = journal
                                            else:
                                                skipped_line_no[str(
                                    ...
                                    if search_product:
                                        ...
                                        if self.account_option == 'default':
                                            ...
                                            if isinstance(sheet.cell(row, 3).value, float):
                                                ...
                                                code_str = str(code)
                                                account_id = self.env['account.account'].sudo().search([('code','=',code_str)],limit=1)
                                                if account_id:
                                                    account = account_id
                                            else:
                                                account_id = self.env['account.account'].sudo().search([('code','=',sheet.cell(row, 3).value)],limit=1)
                                                if account_id:
                                                    account = account_id
                                        if not account:
                                            skipped_line_no[str(
