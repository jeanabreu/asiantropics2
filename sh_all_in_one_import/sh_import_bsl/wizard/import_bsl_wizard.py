...
class ImportBSLWizard(models.TransientModel):
    ...
    def validate_field_selection(self, field_name, field_ttype, field_value,
        ...
        selection_key_value_list = self.env[
            'account.bank.statement.line'].sudo()._fields[field_name].selection
    ...
    def import_bsl_apply(self):
        ...
        if self and self.file and self.env.context.get("sh_abs_id", False):
            print("\n\n\n\ncontext", self.env.context.get("sh_abs_id"))
            #For CSV
            if self.import_type == 'csv':
                for rec in self:
                            ...
                            try:
                                ...
                                if row[0] != '' and row[1] != '':
                                    ...
                                    vals = {
                                        ...
                                        row[1],
                                        'statement_id':
                                        self.env.context.get("sh_abs_id")
                                    }
                    ...
                    if counter > 1:
                        ...
                        res = rec.show_success_msg(completed_bsl,
                                                   skipped_line_no)
                        return res
            ...
            if self.import_type == 'excel':
                for rec in self:
                    ...
                    if counter > 1:
                        ...
                        res = rec.show_success_msg(completed_lead,
                                                   skipped_line_no)
                        return res
